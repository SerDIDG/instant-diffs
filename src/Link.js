...
class Link {
    ...
    constructor( node, options ) {
        ...
        if ( this.mw.hasLink ) {
            ...
            this.mw.isAltTitle = utilsLink.isMWLink( this.mw.link, id.config.mwLinkAltTitle );
            this.mw.isDiffOnly = utilsLink.isMWLink( this.mw.link, id.config.mwLinkDiffOnly );
            this.mw.isExcluded = utilsLink.isMWLink( this.mw.link, id.config.mwLinkExclude );
            if ( !this.mw.isExcluded ) {
                this.options.behavior = 'basic';
            }
            this.mw.isPrepend = utilsLink.isMWLink( this.mw.link, id.config.mwLinkPrepend );
            if ( this.mw.isPrepend ) {
                this.options.insertMethod = 'insertBefore';
            }

            this.mw.line = utilsLink.getMWLine( this.mw.link );
            if ( this.mw.line ) {
