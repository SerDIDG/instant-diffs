...
class Link {
    ...
    constructor( node, options ) {
        ...
        // Check if a link was opened from the Window dialog
        if ( id.local.window?.isParent( this.node ) ) {
            this.options.initiatorWindow = id.local.window;
            this.options.initiatorDiff = id.local.window.getDiff();
        }
    ...
    renderAction( params ) {
        params = {
            ...
            title: null,
            href: null,
            target: utils.getTarget( this.options.initiatorWindow ),
            handler: null,
            classes: [],
            modifiers: [],
